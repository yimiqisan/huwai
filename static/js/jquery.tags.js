...
//            var removeTagIcon = $('<span></span>').addClass('ui-icon ui-icon-close');
            ...
            var removeTag = this.options.editAble ? $('<a href="javascript:;"><span class="text-icon">\xd7</span></a>').addClass('tagit-close').click(function(e) {that.removeTag(tag);}) : $('<a><span class="text-icon">●</span></a>').addClass('tagit-close')
